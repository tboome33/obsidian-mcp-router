---
description: Roll up wiki-meta/journal.md entries into a structurally-idempotent fold page — extractive summarization with backlinks to children. (Skill `wiki-fold` handles natural-language triggers.)
---
...
- Update `wiki-meta/catalog.md` to add a row under `## Folds`.
- Append the fold operation to `wiki-meta/journal.md`.
