---
description: Ingest a source (URL, file, or pasted text) into the wiki — extracts entities and concepts, files them as cross-referenced wiki pages, and updates index/log/hot. Single source or batch (multiple sources fan out via the wiki-ingest sub-agent). Use after the wiki is scaffolded to feed it.
---
