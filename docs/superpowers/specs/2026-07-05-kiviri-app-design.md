...
- **IA-6** : **mode fusion** (D25) — débat multi-LLM arbitré, ancré dans le vault, verdict filable en note. Orchestrateur maison + juge GLM self-hosté + OpenRouter en tuyau.
